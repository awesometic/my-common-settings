...
if [[ "$OSTYPE" == *"linux-gnu"* ]]; then
    ...
    if [[ "${DESKTOP,,}" == *"pantheon"* ]] || [[ "${DESKTOP,,}" == *"gnome"* ]]; then
        ...
        PACKAGES="zsh neovim tmux iotop iftop hardinfo neofetch shellcheck nodejs npm base-devel uboot-tools ttf-dejavu ibus-hangul xclip noto-fonts-cjk docker"
    fi
